...
function toggleBannerDismiss() {
  bannerUp.value = false;
}

const bannerUp = ref(true);
</script>

<template>
  <div class="fixed inset-x-0 mt-2 pb-2 sm:pb-5" v-if="bannerUp">
      ...
      <div class="rounded-lg bg-indigo-600 p-2 shadow-lg sm:p-3">
        <div class="flex flex-wrap items-center justify-between">
          ...
          <div class="order-2 flex-shrink-0 sm:order-3 sm:ml-2">
            <button type="button" @click="toggleBannerDismiss" class="-mr-1 flex rounded-md p-2 hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-white">
